...
public class GeoStrataRecipeProvider extends RecipeProvider {
    ...
    public GeoStrataRecipeProvider(PackOutput output) {
        super(output);
    }
    ...
    private void buildType(Consumer<FinishedRecipe> out, StoneType type) {
        String n          = type.name();
    ...
    private void cut(Consumer<FinishedRecipe> out, Item input, Item result, int count, String id) {
    ...
    private static ResourceLocation rl(String path) {
        return new ResourceLocation(GeoStrata.MOD_ID, path);
    }
}
